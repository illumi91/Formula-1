...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/f1databrickscourself/raw/circuits.csv", header true)
...
# MAGIC )
# MAGIC USING CSV
# MAGIC OPTIONS (path "/mnt/f1databrickscourself/raw/races.csv", header=True)
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/f1databrickscourself/raw/constructors.json")
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS (path "/mnt/f1databrickscourself/raw/drivers.json")
...
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/f1databrickscourself/raw/results.json")
...
# MAGIC time STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dl/raw/pit_stops.json", multiLine true)
...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dl/raw/lap_times")
...
# MAGIC raceId INT)
# MAGIC USING json
# MAGIC OPTIONS (path "/mnt/formula1dl/raw/qualifying", multiLine true)
