...
df_race_results_groupby = df_race_results.groupBy("race_year", "constructor_name") \
...
constructor_standings_df = df_race_results_groupby.withColumn("rank", rank().over(window_spec)) \
...
overwrite_partition(constructor_standings_df, "f1_presentation", "constructor_standings", "race_year")
